...
# Config (edit these)
# ----------------------------
IMAGE_PATH = r"unet_test_ice.jpg"      # your 4000x3000 RGB image (or JPG/PNG)
MASK_PATH  = r"unet_test_ice_mask.png"       # CVAT exported mask (same size as image)
OUT_DIR    = r"dataset_tiles"  # output folder
